...
方式	               利点	                                        欠点
=================== =========================================== ========================================================================
SNI                 サーバーの設定だけで動作（標準）                         Windows XP와 IE6 미지원
Multi Certificate	証明書のみを交換して動作                           메인 도메인 또는 서비스 주체가 같아야 함
Multi Port          ポートマン変更して動作                             웹 페이지에서 HTTPS포트를 명시해주어야 함
Multi NIC	        サーバーの設定だけで動作（最も広く使わ）                NIC와 IP추가 구성필요
=================== =========================================== ========================================================================
