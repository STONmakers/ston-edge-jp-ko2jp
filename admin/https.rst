...
方式	               利点	                                        欠点
=================== =========================================== ========================================================================
SNI                 서버설정만으로 동작 (표준)                         Windows XPとIE6非対応
Multi Certificate	인증서만 교체하여 동작                            メインドメインまたはサービス主体が同じで、ややもする再発行が頻繁することがあります
Multi Port          포트만 변경하여 동작                             WebページからのHTTPSポートを明示ヘジュオヤする
Multi NIC	        서버설정만으로 동작 (가장 널리쓰임)                  NICとIPの追加構成が必要
=================== =========================================== ========================================================================
...
Multi Certificate	証明書のみを交換して動作	               メインドメインまたはサービス主体が同じで、ややもする再発行が頻繁することがあります
